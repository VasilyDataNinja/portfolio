...
<h2 align="center">Я начинающий аналитик данных. В этом репозитории вы можете найти некоторые из моих проектов, выполненных во время обучения и практики. Здесь будут понравившиеся мне кейсы и SQL запросы.</h2>
...
<li>Первые две гипотезы проверить несколькими вариантами запросов</li>
<li>В течение 2017 года суммарный объем поступающих денежных средств снижался в связи со снижением как суммарного количества проводимых уроков, так и общего количества учащихся студентов</li>
</ul>
